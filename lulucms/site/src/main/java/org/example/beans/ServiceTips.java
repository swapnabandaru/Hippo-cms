...
@XmlRootElement(name = "servicetips")
@XmlAccessorType(XmlAccessType.NONE)
@HippoEssentialsGenerated(internalName = "lulucms:ServiceTips")
@Node(jcrType = "lulucms:ServiceTips")
public class ServiceTips extends BaseDocument {
    @XmlElement
    ...
    @XmlElement
    @HippoEssentialsGenerated(internalName = "lulucms:securityTip5")
    public String getSecurityTip5() {
        return getProperty("lulucms:securityTip5");
    }
}
